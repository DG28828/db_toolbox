function db_register_campaign(db_dir, Sitio, Camp, start_date, end_date, raw_bursts, clean_bursts, fs_Hz, wave_burst_duration_s, blanking_distance_m, mounting_height, instrument_serial, head_serial, clean_status, proc_status, raw_nc, proc_nc)
    ...
    if isempty(wave_burst_duration_s)
        wave_burst_duration_s = "";
    else
        wave_burst_duration_s = string(wave_burst_duration_s);
    end

    if isempty(blanking_distance_m)
        blanking_distance_m = "";
    else
        blanking_distance_m = string(blanking_distance_m);
    end
