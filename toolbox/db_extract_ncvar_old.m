...
for s = 1:numel(sites)
    ...
    for c = 1:numel(camps_site)
        ...
        has_burst = ~isempty(burst_dim_idx);
        ...
        try
            [data, nburst_selected] = local_read_variable(ncfile, var_path, info_var, opts.Burst, burst_dim_idx, timezone);
